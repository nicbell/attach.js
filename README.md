#Intro [![Build Status](https://travis-ci.org/nicbell/attach.js.png?branch=master)](https://travis-ci.org/nicbell/attach.js) [![NPM](https://nodei.co/npm/attach.js.png?mini=true)](https://nodei.co/npm/attach.js/)
